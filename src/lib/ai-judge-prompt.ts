...
export function buildJudgePrompt(input: JudgePromptInput): string {
  ...
  return [
    ...
    "- 예시값은 허용 형식과 의미의 대표값입니다. 실제값이 예시와 다른 표기 체계·코드·축약형이면 규칙이 명시적으로 허용하지 않는 한 실패입니다.",
    '- 예: 기대 예시가 "일본"인데 실제값이 "OKA"인 경우, 임의로 지명이나 코드의 의미를 추론해 통과시키지 말고 실패로 판정하세요.',
    "- 실제값이 기대 형식·의미에 맞는지 불확실하거나 근거가 부족하면 보수적으로 실패로 판정하고 이유를 적으세요.",
